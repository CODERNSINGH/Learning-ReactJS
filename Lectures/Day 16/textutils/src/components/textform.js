...
export default function TextForm(props) {
    ...
    const handlecopuclick = () => {
        ...
        props.showalert("Copied to Clipboard you can paste anywhere", "success")
    }
    return (
        ...
        <>
            ...
            <div className={`container my-3`}>
                <h1 className={`text-${props.mode ==='dark'?'light':'dark'}`} >Your text Summary is {props.mode==='dark'?'light':'dark'}</h1>
